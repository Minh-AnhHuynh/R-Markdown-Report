...
```{r osteosarcoma_plot, echo = FALSE, fig.height=12, fig.width=15, fig.cap="**Heatmap of HP Osteosarcoma signature with samples annotated to their respective inflammatory groups.**"}
...
In order to characterize osteosarcomas, the _Hp Osteosarcoma_ gene signature from MSigDB was used to see whether the inflammatory groups can be related to gene expression from this signature(**Figure \@ref(fig:osteosarcoma_plot)**). Visually, the heatmap representing the gene signature, annotated with the inflammatory groups, does seem to indicate that the samples express genes differently between Low, Medium and High inflammation group.
...
<!-- # stat_tukey %>% add_xy_position(x = "Group") -->
<!-- # This doesn't work -->
...
<!--   stat_pvalue_manual(stat_tukey, label = "p.adj", -->
<!--                      y.position = c(3500,3100,2900)) -->


<!-- ``` -->

<!-- ```{r estimate_violin, fig.cap="ESTIMATE", fig.height=10, fig.width=15, cache=FALSE} -->


<!-- vep <- ggarrange(ve, labels = "AUTO") -->
