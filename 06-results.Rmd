...
```{r volc-plot, dependson=deseq2, echo=FALSE, out.width="60%", fig.height=6, fig.width=6, dependson="deseq2", fig.cap="**Volcano plot of the differentially expressed genes in Low vs High condition.** Positive log~2~ of fold change represent a gene that is more differentially expressed Low condition, and _vice versa_. Adjusted *P* value were obtained by FDR testing. *P* ≤ 0.05 and log~2~ fold change ≤ 1 or ≥ 1 was used for cutoff. FDR = False Discovery Rate"}
...
inflammation **(Figure \@ref(fig:enrichr-plot))**. Interestingly, enrichment of downregulated genes in GO Biological Process database returned a lot of pathways linked to immune cell chemotaxis, notably neutrophil chemotaxis.
