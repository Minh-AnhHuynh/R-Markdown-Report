...
mds_plot <- knitr::include_graphics("../Osteosarcoma-Project/TargetOS-Osteosarcoma/04_figures/MDS/MDS-metaMDS-hallmark_inflammatory-8_kcluster-Z_score.png")
inflam_group <- knitr::include_graphics("../Osteosarcoma-Project/TargetOS-Osteosarcoma/04_figures/ggplot/hallmark_mean_vs_sample+group_mean.png")
...
knitr::include_graphics("../Osteosarcoma-Project/TargetOS-Osteosarcoma/04_figures/ggplot/hallmark_mean_vs_sample+group_mean.png")
```
...
Comparison of the mean of _Hp Osteosarcoma_ gene signature and gene relating to types of osteosarcomas associated to inflammatory groups were performed, represented through a heatmap. Despite high heterogeneity between samples and inflammatory status, the Z-score of the mean of the genes in Low versus High group is statistically different.
