...
[@Becht.2016]. Non-metric Kruskal-Wallis testing was used to determine
significant differences between cell populations between Low, Medium and
High groups with *P \< 0.05* were considered as statistically
significant.
...
Statistical testing was performed using *R software 4.2.0 (2022-04-22)*.
Kruskal-Wallis testing was performed for non-metric comparative analysis
between groups. Post-hoc analysis was performed using Dunn's test as
opposed to Wilcoxon due to the test taking into account Kruskal-Wallis's
rank. P \< 0.05 and P.adj \< 0.05 was considered statistically
significant.
